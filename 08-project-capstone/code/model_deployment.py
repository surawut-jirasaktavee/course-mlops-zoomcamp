...
Deployment(
    name="customer_churn_prediction_model_lightgbm",
    flow=model_experiment,
    schedule=CronSchedule(cron="0 0 1 * *"), # At 00:00 on every first day of that month 
    flow_runner=SubprocessFlowRunner(),
    tags=["Customer_Churn_Prediction"]
)

print(f"Deployment is successfully")
